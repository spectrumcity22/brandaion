-- Safe creation of robust format_ai_request trigger - NO DESTRUCTIVE OPERATIONS
-- This only creates the trigger if it doesn't exist
...
-- Create the robust function (this is safe - it replaces the function)
